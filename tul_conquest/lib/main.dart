...
class _MyAppState extends State<MyApp> {
  ...
  void dodajZnacznikiDoListy(
    ...
    znaczniki.add(Marker(
        ...
        onTap: () {
          if (markerVisibilityList[0]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747000, 19.451992), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[1]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747344, 19.455063), 19.0));
              funkcjaZnacznikow();
              tekstZagadki = "_lan_";
              kluczZagadki = "Gaz";
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[2]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.745060, 19.453975), 19.0));
              funkcjaZnacznikow();
              tekstZagadki =
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[3]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747794, 19.454366), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[4]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.746690, 19.453912), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[5]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747465, 19.455995), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[6]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747634, 19.451893), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[7]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.748952, 19.454690), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[8]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.748810, 19.455350), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[23]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747708, 19.453324), 19.0));
              funkcjaZnacznikow();
              tekstZagadki = "Rok";
              kluczZagadki = "1558";
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[10]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.746909, 19.456282), 19.0));
              funkcjaZnacznikow();
              tekstZagadki = "Ile V?";
              kluczZagadki = "400";
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[11]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747198, 19.456007), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[12]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.746465, 19.455791), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[13]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.746409, 19.455395), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[14]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.745674, 19.455323), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[15]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747571, 19.450931), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[16]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747704, 19.452855), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[17]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747965, 19.451947), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[18]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747796, 19.450893), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[19]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.748666, 19.453617), 19.0));
              funkcjaZnacznikow();
              tekstZagadki = "Bez";
              kluczZagadki = "Lipy";
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[20]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.748359, 19.455163), 19.0));
              funkcjaZnacznikow();
              tekstZagadki =
                  "Podstawa bryły tworzonej przez podpory drzewa to:";
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[21]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.746696, 19.454084), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[22]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.748300, 19.456389), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[9]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.748921, 19.456253), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[24]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.746006, 19.454548), 19.0));
              funkcjaZnacznikow();
              tekstZagadki =
                  "Instytut papiernictwa i ... Politechniki Łódzkiej";
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[25]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.748593, 19.453803), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[26]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.746099, 19.456230), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[27]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.745681, 19.453580), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[28]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747209, 19.455656), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[29]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.747127, 19.453993), 19.0));
              funkcjaZnacznikow();
              tekstZagadki = "Rok:";
              kluczZagadki = "2004";
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[30]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.745913, 19.455619), 19.0));
              funkcjaZnacznikow();
    ...
    znaczniki.add(Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueAzure),
        onTap: () {
          if (markerVisibilityList[31]) {
            this.setState(() {
              controller.animateCamera(CameraUpdate.newLatLngZoom(
                  LatLng(51.745371, 19.451457), 19.0));
              funkcjaZnacznikow();
  ...
  Future funcThatMakesAsyncCall() async {
    var result = await Geolocator().distanceBetween(
        ...
        lokacjaZnacznika.latitude,
        lokacjaZnacznika.longitude);
    this.setState(() {
      dist = result;
    });
  }
